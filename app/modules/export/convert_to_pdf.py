...
# --- INICIO FUNCIONALIDAD US-PDF-ELITE: MOTOR DE ESTILOS CORPORATIVOS v3.4.7 ---
        ...
        <head>
            ...
            <style>
                @page {{ 
                    ...
                    @bottom-left {{ content: "KDP Master Suite Elite"; font-size: 9pt; color: #64748b; }}
                }}
                body {{ font-family: 'Segoe UI', 'Helvetica', sans-serif; line-height: 1.6; color: #1e293b; max-width: 950px; margin: 0 auto; padding: 20px; }}
                h1, h2, h3, h4 {{ color: #0f172a; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px; page-break-after: avoid; font-weight: 700; }}
                h1 {{ font-size: 2.4em; border-bottom: 3px solid #3b82f6; margin-top: 0; }}
                h2 {{ font-size: 1.5em; }}
                h3 {{ font-size: 1.25em; }}
...
# --- FIN FUNCIONALIDAD US-PDF-ELITE ---
