...
<compliance_check>
Si una tarea de desarrollo implica añadir una dependencia de terceros o alterar el flujo central, el agente debe dispara una alerta <EXTERNAL_DEP_WARNING> / <ARCH_VIOLATION> antes de proceder.
</compliance_check>

---

## 📦 MODULOS Y FUNCIONALIDADES ACTUALES
name: modules-and-features
description: Inventario completo de módulos implementados en KDP_MASTER.
<app_modules>
processing/validate_config.py, processing/services.py, processing/pipeline.py, processing/merge_master_kb.py, processing/integrate_knowledge.py, processing/integrate_kb.py, processing/cleanup_kb_duplicates.py, processing/classify_kb.py
monitoring/webhook_dispatcher.py, monitoring/watcher.py, monitoring/version.py, monitoring/verify_monitor.py, monitoring/smoke_test.py, monitoring/run_tests.py, monitoring/run_build.py, monitoring/monitor_cli.py, monitoring/monitor_background.py, monitoring/health_check.py, monitoring/dependency_auditor.py, monitoring/analytics_engine.py
export/push_md.py, export/push_gui.py, export/push_all.py, export/export_kb.py, export/convert_to_pdf.py
download/__init__.py
backup/restore.py, backup/integrity_check.py, backup/backup_manager.py
ai/gemini_wrapper.py
</app_modules>
<app_services>
yt_dlp_errors.py, selection_manager.py, retry_decorator.py, processing_service.py, processed_videos_tracker.py, monitor_service.py, metadata_parser.py, metadata_enricher.py, manual_content_merger.py, knowledge_integrator.py, kb_export_service.py, kb_export_scheduler.py, kb_exporter.py, gem_agent_service.py, file_indexer.py, export_audit.py, error_mapper.py, duplicate_export_scheduler.py, duplicate_detector.py, download_service.py, disaster_recovery.py, channel_curation_engine.py, backup_service.py, auto_decision_engine.py, advanced_analytics.py
</app_services>
<app_database>
knowledge_db.py, db_manager.py, batch_manager.py
</app_database>
<app_core>
utils.py, task_queue.py, security.py, scheduler.py, safe_ai_wrapper.py, plugin_manager.py, ollama_pool.py, notification_router.py, notification_hub.py, agent_loader.py, doc_updater.py
</app_core>
<ui_tabs>
download_tab.py, dashboard_tab.py
</ui_tabs>
<herramientas_externas>
transcription/run_transcriptions.py, stress_test_processing.py, stress_test_exe.py, packaging/silent_install.py, packaging/portable_check.py, packaging/checksum.py, monitoring/port_manager.py, monitoring/channel_monitor.py, maintenance/migrate_kb.py, maintenance/cleanup_dashboard.py, maintenance/cleanup.py, maintenance/check_updates.py, git/sync.py, git/github_push.py, generators/role_graph.py, generators/instructions.py, generators/category_report.py, fix/fix_paths.py, fix/fix_gui_app.py, dev/test_file.py, dev/setup_project.py, dev/organize_structure.py, analytics/metadata_coverage.py, db/check_db.py, convert/channels.py, analytics/diagnostic.py, analytics/calculators.py, amazon/__init__.py, affinity/__init__.py
</herramientas_externas>
<archivos_principales>
gui_app.py, ui_backend.py, review_queue.py
</archivos_principales>
<spec_files>
KDP_Master_Suite_v3.4.7.spec, KDP_Master_Suite_v3.4.7_Elite.spec, KDP_Master_Suite_v3.4.4.spec, KDP_Master_Suite_v2.5.10.spec, main.spec, KDP_Transcriptions.spec
</spec_files>
...
## 🔧 BUILD SYSTEM
name: build-system
description: Sistema de construcción de ejecutables.
<build_pipeline>
El build se ejecuta mediante run_build.py en app/modules/monitoring/ que usa PyInstaller con archivos .spec
El entry point principal es gui_app.py
Los ejecutables se generan en la carpeta dist/
</build_pipeline>
<build_exe_wrapper>
Se proporciona build_exe.py como wrapper para ejecutar el pipeline de build
