...
## MISIÓN
Evaluar la interfaz de usuario, experiencia, accesibilidad y consistencia visual para aplicaciones de escritorio Python Offline-First.
...
- Senior Software Engineer (Desktop GUI)
